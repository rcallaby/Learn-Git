...
- [介绍](#introduction)
- [打开 BASH 终端](#opening-the-bash-terminal)
- [浏览目录](#navigating-through-directories)
- [列出目录内容](#listing-directory-contents)
- [创建和移动目录](#creating-and-removing-directories)
- [创建和删除文件](#creating-and-removing-files)
- [结论](#conclusion)
